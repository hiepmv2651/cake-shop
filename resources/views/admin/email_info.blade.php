                        ...
                        <form action="{{ url('send_user_email', $user->id) }}" method="POST">
                            ...
                            <div>
                                ...
                                <x-jet-input id="greeting" class="block mt-1 w-full input_color" type="text"
                                    name="greeting" :value="old('ngaydat')" required autofocus autocomplete="greeting" />
                                @error('greeting')
                            ...
                            <div class="mt-4">
                                ...
                                <x-jet-input id="body" class="block mt-1 w-full input_color" type="text"
                            ...
                            <div class="mt-4">
                                ...
                                <x-jet-input id="button" class="block mt-1 w-full input_color" type="text"
                                    name="button" :value="old('button')" required />
                                @error('button')
                                    <p class="mt-3 list-disc list-inside text-sm text-red-600">
                                        {{ $message }}
                                    </p>
                            ...
                            <div class="mt-4">
                                ...
                                <x-jet-input id="url" class="block mt-1 w-full input_color" type="text"
