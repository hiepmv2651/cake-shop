                    ...
                    <div class="w-full sm:max-w-md px-6 py-4 my-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                        <form action="{{ url('/edit_product', $data->id) }}" method="post"
                            ...
                            <div>
                                ...
                                <x-jet-input id="title" class="block mt-1 w-full input_color" type="text"
                                    name="title" value="{{ $data->title }}" required autocomplete="title" />
                                @error('title')
                            ...
                            <div class="mt-4">
                                ...
                                <x-jet-input id="price" class="block mt-1 w-full input_color" type="number"
