        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="div_center">
                    ...
                    <h2 class="h2_font">Sửa Thông Tin Danh Mục</h2>
                ...
                <div class="min-h-screen flex flex-col sm:justify-center items-center pt-1 sm:pt-0 bg-gray-100">
                    <div class="w-full sm:max-w-md px-6 py-4 my-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                        <form action="{{url('/edit_category', $data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf

                            <div>
                                <x-jet-label for="title" value="{{ __('Tên') }}" />
                                <x-jet-input id="title" class="block mt-1 w-full input_color" type="text" name="category_name" value="{{$data->category_name}}" required autocomplete="title" />
                                @error('category_name')
